'''
Sample Usage:-
python calibration.py --dir Images\img
'''
...
if __name__ == '__main__':
    ...
    ap.add_argument("-t", "--height", type=int, help="Height of checkerboard (default=6)", default=10)
    ap.add_argument("-s", "--square_size", type=float, default=0.015, help="Length of one edge (in metres)")
